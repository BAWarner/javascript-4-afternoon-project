...
class ProgressiveManager extends Manager{
  ...
  //   }else if(reportsLength >= 4 && reportsLength <=10 ){
  //     this.title = 'Mosty Manager';
  //   }else if(reportsLength >= 11 && reportsLength <= 50){
  //     this.title = 'Manager';
  //   }else if(reportsLength >= 51 && reportsLength <= 100){
  //     this.title = 'Manager Plus';
  //   }else if(reportsLength >= 101){
...
class Machine{
  ...
  makeWidgets(widgetsMade){
    this.widgets_made_count += widgetsMade;
    let newWearAndTear = this.widgets_made_count / 50;
    this.wear_and_tear_count = newWearAndTear;
